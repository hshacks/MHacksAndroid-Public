...
import com.hshacks.ii.android.time.TimeDelta;
import com.hshacks.ii.android.views.PinnedSectionListView;
...
public class WorkshopAdapter extends ArrayAdapter<WorkshopAdapter.Item> implements PinnedSectionListView.PinnedSectionListAdapter{
    private Context mContext;
    private ArrayList<Item> mItems;
    private ArrayList<ParseObject> mEvents;

    public WorkshopAdapter(Context context, ArrayList<ParseObject> announcements) {
